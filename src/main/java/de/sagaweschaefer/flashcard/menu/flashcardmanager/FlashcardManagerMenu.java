...
public class FlashcardManagerMenu {
    ...
    public FlashcardManagerMenu(FlashcardManagerMenuHelper flashcardManagerMenuHelper, String flashcardSetName) {
        this.flashcardManagerMenuHelper = flashcardManagerMenuHelper;
        this.menu = new Menu("Flashcard Manager für Set: " + flashcardSetName);
        setupMenu();
    }
    ...
    private void setupMenu() {
        ...
        menu.addItem(0, new MenuItem("Zurück", () -> {
        }, true));
    }
