...
public class JsonSessionResultRepository implements SessionResultRepository {
    private final String filePath;
    private final ObjectMapper objectMapper;

    public JsonSessionResultRepository(String filePath) {
    ...
    public List<SessionResult> findAll() {
        ...
        try {
            ...
            System.out.println("Fehler beim Laden der Ergebnisse: " + e.getMessage());
            return new ArrayList<>();
        }
    }
    ...
    public void saveAll(List<SessionResult> results) {
        ...
        try {
            ...
            System.out.println("Fehler beim Speichern der Ergebnisse: " + e.getMessage());
        }
    }
}
